                ...
                <form method="GET" action="{{ route('orders.index') }}" class="flex items-center">
                    <div class="relative">
                        <input 
                            ...
                            class="w-64 rounded-lg border border-gray-300 bg-white px-4 py-2 pl-9 text-sm text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                        >
                    ...
                    <button type="submit" class="ml-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700">
                        Search
                    </button>
                    @if($search)
                        <a href="{{ route('orders.index') }}" class="ml-2 text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400">
                            Clear
                        </a>
                    @endif
                </form>
                <a href="{{ route('orders.create') }}" class="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
