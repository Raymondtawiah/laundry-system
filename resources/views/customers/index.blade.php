                            ...
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="inline-flex rounded-full bg-purple-100 px-2 py-0.5 text-xs font-medium text-purple-800 dark:bg-purple-900 dark:text-purple-200">
                                            {{ $customer->branch ?? 'N/A' }}
                                        </span>
                                    </div>
                                    @if($customer->notes)
                                        <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ $customer->notes }}</div>
                                    @endif
                                ...
                                @if(auth()->user()->role === 'admin')
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('customers.show', $customer) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300" title="View Details">
                                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
