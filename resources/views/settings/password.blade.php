<x-layouts::app :title="__('Password Settings')">
    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-4 sm:p-6">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Password Settings</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div class="lg:col-span-1">
                <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                    <nav class="space-y-1">
                        ...
                        <a href="{{ route('user-password.edit') }}" class="flex items-center gap-3 rounded-lg bg-blue-50 px-3 py-2 text-sm font-medium text-blue-700">
                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="lg:col-span-2">
                <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                    <h2 class="text-lg font-semibold text-gray-900 mb-1">Update Password</h2>
